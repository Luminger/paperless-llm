// Vendored in the style of the sibling dialog.tsx (AUDIT UI-U3).
// AlertDialog = the interruptive variant: role="alertdialog", focus
// lands inside, NO outside-click/Esc-accident dismissal.
