...
Revision ID: be2f530fc15c
Revises: 
Create Date: 2026-07-17 15:36:37.832130
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('draft', 'pending', 'approved', 'rejected', 'applied', 'superseded', name='proposalstatus', native_enum=False), nullable=False),
    sa.Column('entity_type', sa.Enum('document', 'tag', 'correspondent', 'document_type', 'storage_path', name='entitytype', native_enum=False), nullable=True),
    sa.Column('entity_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
